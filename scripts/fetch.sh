...
REPOS="poky metaoe metaraspberrypi metaiotcloud metajava"
...
METARASPBERRYPI_URI="git://git.yoctoproject.org/meta-raspberrypi"
...
METAJAVA_REV="${METAJAVA_REV-refs/remotes/origin/${branch}}"

METAIOTTEST_URI="."
METAIOTTEST_PATH="poky/meta-iot-cloud-test"
...
rm -rf "${METAIOTTEST_PATH}" || die "unable to clear old ${METAIOTTEST_PATH}"
ln -sf "../${METAIOTTEST_URI}" "${METAIOTTEST_PATH}" || \
	die "unable to symlink ${METAIOTTEST_PATH}"
